...
$quarters = ["Q3FY15", "Q4FY15", "Q1FY16", "Q2FY16", "Q3FY16", "Q4FY16", "Q1FY17", "Q2FY17"];
...
$keys = ["< 1 Month", "1-3 Months", "> 3 Months"];
$keys = ["Conferencing", "Contact Center", "Other Collaboration", "TP Endpoints", "TP Multiparty Conferencing", "UC Endpoints", "UC Infrastructure Applications"];
$keys = ["AS Renew", "SWSS Renew", "TS Renew"];


$keys = ["Current", "Overdue", "Expired"];
...
//            }
        ...
        foreach ($keys as $k) {
            $freq_obj_2->$k = rand(10, 45) * 10000000;
        }
