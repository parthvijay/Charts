...
//$quarters = ["Jan FY16", "Feb FY16", "Mar FY16", "Apr FY16", "May FY16", "Jun FY16", "Jul FY16", "Aug FY16", "Sep FY16"];
//$quarters = ["FY10", "FY11", "FY12", "FY13", "FY14", "FY15", "FY16", "FY17", "FY18", "FY19"];
//$quarters = ["Enterpr.", "Security", "Collab", "DCV", "SP"];
//$quarters = ["Q3FY16", "Q4FY16"];
//$quarters = ["Q1FY14", "Q2FY14", "Q3FY14", "Q4FY14", "Q1FY15", "Q2FY15", "Q3FY15", "Q4FY15", "Q1FY16", "Q2FY16", "Q3FY16", "Q4FY16", "Q1FY17", "Q2FY17"];
//$quarters = ["Q1FY16", "Q2FY16", "Q3FY16", "Q4FY16"];
...
//$quarters = ["W1", "W2", "W3", "W4", "W5", "W6", "W7", "W8", "W9", "W10", "W11", "W12", "W13"];
//$quarters = ["Collaboration"];
...
//$areas = ["Canada"];
//$areas = ["FY11", "FY12", "FY13", "FY14", "FY15", "FY16", "FY17", "FY18", "FY19"];
...
//$areas = ["Telstra Corporation", "AT&T Collaboration", "Verizon Wireless", "Microsoft CorpIT", "Ingram Micro Inc"];
//$areas = ["Telstra Corporation", "AT&T Collaboration", "Verizon Wireless", "Microsoft CorpIT", "Ingram Micro Inc", "British Telecom", "Ingram Micro", "Wells Fargo Us", "EMC Corporation", "AT&T MTOP", "Verizon HQ", "Rogers Canada", "IP Core", "Kaiser", "Oracle", "Walgreens", "HCA Inc", "IBM Japan", "KPN", "Fujitsu", "USD", "CITI US", "Swisscom", "Fastweb Spa", "CTC"];
...
$keys = ["Remaining", "On Time", "Late", "Missed", "Opportunity"];
//$keys = ["Active", "Expired", "Overdue", "Opportunity"];
$keys = ["Renew", "Refresh"];
//$keys = ["1st Month", "2nd Month", "3rd Month"];
//$keys = ["Early", "Ontime", "Late1 Month", "Late2 Months"];
//$keys = ["Canada", "GES", "US-PS", "US-Select-Com", "US-SMB", "US-Terr-Com"];
//$keys = ["Early", "On Time", "Late", "Missed", "Remaining"];
...
foreach ($quarters as $q) {
    ...
    foreach ($areas as $a) {
        ...
        foreach ($keys as $ind => $k) {
            if ($k == 'Opportunity' || true) {
                $freq_obj->$k = rand(10, 45) * 100000;
            } else {
                $freq_obj->$k = 0;
            }
